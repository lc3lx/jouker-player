...
const TRANSITIONS = {
  [STATE.WAITING]: [STATE.COUNTDOWN, STATE.BIDDING_SYRIAN, STATE.ROUND_END, STATE.GAME_END],
  [STATE.COUNTDOWN]: [STATE.WAITING, STATE.BIDDING_SYRIAN, STATE.ROUND_END, STATE.GAME_END],
  [STATE.BIDDING_SYRIAN]: [STATE.BIDDING_SYRIAN, STATE.PLAYING, STATE.ROUND_END, STATE.GAME_END],
  [STATE.PLAYING]: [STATE.ROUND_END, STATE.GAME_END],
