/**
 * Zenobia jackpot — shared Poseidon match-3 scratch (same as Zeus / Atlantis / Tree).
 * Trigger: 3+ "jackpot" cells on the final 6×5 matrix.
 */
...
const { JACKPOT } = require("./constants");

const JP = JACKPOT || JACKPOT_SYMBOL;
