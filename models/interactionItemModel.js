...
const DEFAULT_ITEMS = [
  ...
  // Stickers — fly from sender seat to the tapped player (admin can add more).
  { key: "sticker_bike", name: "Motorcycle", nameAr: "دراجة", icon: "🏍️", animation: "sticker_fly", category: "sticker", rarity: "rare", price: 3000, cooldownMs: 4000, sortOrder: 20 },
  { key: "sticker_yacht", name: "Yacht", nameAr: "يخت", icon: "🛥️", animation: "sticker_fly", category: "sticker", rarity: "epic", price: 8000, cooldownMs: 5000, sortOrder: 21 },
  { key: "sticker_plane", name: "Plane", nameAr: "طائرة", icon: "✈️", animation: "sticker_fly", category: "sticker", rarity: "epic", price: 6000, cooldownMs: 4000, sortOrder: 22 },
  { key: "sticker_car", name: "Sports Car", nameAr: "سيارة", icon: "🏎️", animation: "sticker_fly", category: "sticker", rarity: "epic", price: 7500, cooldownMs: 5000, sortOrder: 23 },
  { key: "sticker_santa", name: "Santa", nameAr: "سانتا", icon: "🎅", animation: "sticker_fly", category: "sticker", rarity: "rare", price: 2500, cooldownMs: 3000, sortOrder: 24 },
  { key: "sticker_snowman", name: "Snowman", nameAr: "رجل ثلج", icon: "⛄", animation: "sticker_fly", category: "sticker", rarity: "common", price: 1500, cooldownMs: 3000, sortOrder: 25 },
  { key: "sticker_roses", name: "Roses", nameAr: "ورود", icon: "💐", animation: "sticker_fly", category: "sticker", rarity: "rare", price: 4000, cooldownMs: 3000, sortOrder: 26 },
  { key: "sticker_gavel", name: "Gavel", nameAr: "مطرقة", icon: "⚖️", animation: "sticker_fly", category: "sticker", rarity: "rare", price: 3500, cooldownMs: 3000, sortOrder: 27 },
  { key: "sticker_beer", name: "Cheers", nameAr: "كأسين", icon: "🍻", animation: "sticker_fly", category: "sticker", rarity: "common", price: 2000, cooldownMs: 2500, sortOrder: 28 },
  { key: "sticker_rocket", name: "Rocket", nameAr: "صاروخ", icon: "🚀", animation: "sticker_fly", category: "sticker", rarity: "epic", price: 5000, cooldownMs: 4000, sortOrder: 29 },
  { key: "sticker_kiss", name: "Kiss", nameAr: "قبلة", icon: "💋", animation: "sticker_fly", category: "sticker", rarity: "common", price: 1200, cooldownMs: 2500, sortOrder: 201 },
  { key: "sticker_hearts", name: "Hearts", nameAr: "قلوب", icon: "💕", animation: "sticker_fly", category: "sticker", rarity: "common", price: 1000, cooldownMs: 2500, sortOrder: 202 },
  // Premium gifts
