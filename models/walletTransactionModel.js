...
const walletTransactionSchema = new mongoose.Schema(
  {
    ...
    type: {
      ...
      enum: [
        ...
        "clan_create",
        "clan_donation",
        "clan_tournament_entry",
        "clan_tournament_prize",
        "clan_tournament_refund",
        "arena_tournament_create",
        "arena_tournament_entry",
        "arena_tournament_prize",
        "arena_tournament_refund",
      ],
      required: true,
      index: true,
    },
